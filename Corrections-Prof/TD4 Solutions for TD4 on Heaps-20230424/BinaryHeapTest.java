...
class BinaryHeapTest {
    ...
    @Test
    void testConstructorsWithBuildHeap() {
        initHeap();
        assertArrayEquals(new Integer[]{9, 7, 5, 1, 3}, binaryHeap.getArray());
    }
    ...
    @Test
     void testDeleteExtreme() throws EmptyHeapException {
        initHeap();//attention requiert BinaryHeap(int... array)
    ...
    @Test
    void testFirstQuestionPartOne2b() throws FullHeapException {
        Comparator<Integer> c = (e1, e2) -> e2 - e1;
        LOGGER4Tests.setLevel(Level.INFO);
        BinaryHeap.LOGGER.setLevel(Level.FINE);
        LOGGER4Tests.info("create heap with array");
        ...
        BinaryHeap<Integer> heapQ2 = new BinaryHeap<>(array,c);
        System.out.println(heapQ2.toStringByLevels());
        System.out.println(Arrays.toString(heapQ2.getArray()));
        assertArrayEquals(new Integer[]{1, 3, 2, 12, 6, 4, 8, 15, 14, 9, 7, 5, 11, 13, 10}, heapQ2.getArray());
